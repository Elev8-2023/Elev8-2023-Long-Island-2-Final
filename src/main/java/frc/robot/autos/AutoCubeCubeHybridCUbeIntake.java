...
public class AutoCubeCubeHybridCUbeIntake extends SequentialCommandGroup {
  

    public AutoCubeCubeHybridCUbeIntake (Swerve s_Swerve,Intake intake,Arm arm,Gripper gripper) {

        HashMap<String, Command> eventMap = new HashMap<>();
        
        List<PathPlannerTrajectory> pathgroup1 = PathPlanner.loadPathGroup("Cube+CubeHybrid+CubeIntake", new PathConstraints(3, 3));
        eventMap.put("Intake", new IntakeCube(intake, 10));
        eventMap.put("Hybrid Position", new CubePosition(intake, 75));
        eventMap.put("Hybrid Shot", new ShootCube(intake, 0.9));
        eventMap.put("Intake2", new IntakeCube(intake, 10));
