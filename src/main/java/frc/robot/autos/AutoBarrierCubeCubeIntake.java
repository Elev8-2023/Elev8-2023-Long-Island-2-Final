...
public class AutoBarrierCubeCubeIntake extends SequentialCommandGroup {
   

    public AutoBarrierCubeCubeIntake(Swerve s_Swerve,Intake intake) {

        HashMap<String, Command> eventMap = new HashMap<>();
        
        List<PathPlannerTrajectory> pathgroup1 = PathPlanner.loadPathGroup("CubeBarrierCubeIntake", new PathConstraints(3, 3));
        ...
        eventMap.put("Up",new CubePosition(intake, 10));
