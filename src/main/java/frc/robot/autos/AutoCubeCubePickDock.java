...
public class AutoCubeCubePickDock extends SequentialCommandGroup {
  

    public AutoCubeCubePickDock(Swerve s_Swerve,Intake intake) {

        HashMap<String, Command> eventMap = new HashMap<>();
        
        List<PathPlannerTrajectory> pathgroup1 = PathPlanner.loadPathGroup("Cube+CubePick+Dock", new PathConstraints(3, 3));
        // eventMap.put("Shoot High", new ShootCube(intake, 0.44));
