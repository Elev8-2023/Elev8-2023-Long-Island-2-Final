...
public class AutoPreloadCubeDock extends SequentialCommandGroup {
   

    public AutoPreloadCubeDock(Swerve s_Swerve,Intake intake) {

        HashMap<String, Command> eventMap = new HashMap<>();
        
        List<PathPlannerTrajectory> pathgroup1 = PathPlanner.loadPathGroup("CubeBarrierDock", new PathConstraints(3, 3));
        SwerveAutoBuilder autoBuilder = new SwerveAutoBuilder(
                ...
                new PIDConstants(3.4, 90.0, 0.0), // PID constants to correct for rotation error (used to create the
                                                  // rotation controller)
