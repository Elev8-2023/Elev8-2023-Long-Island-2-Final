...
public class AutoPreloadConeDock extends SequentialCommandGroup {
  

    public AutoPreloadConeDock(Swerve s_Swerve,Intake intake,Arm arm,Gripper gripper) {

        HashMap<String, Command> eventMap = new HashMap<>();
        
        List<PathPlannerTrajectory> pathgroup1 = PathPlanner.loadPathGroup("PreloadCone+Dock", new PathConstraints(3, 3));
