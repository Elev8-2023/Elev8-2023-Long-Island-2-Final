...
public class AutoConeCubeHybridCubeIntake extends SequentialCommandGroup {
  

    public AutoConeCubeHybridCubeIntake(Swerve s_Swerve,Intake intake,Arm arm,Gripper gripper) {

        HashMap<String, Command> eventMap = new HashMap<>();
        
        List<PathPlannerTrajectory> pathgroup1 = PathPlanner.loadPathGroup("Cone+CubeHybrid+CubeIntake", new PathConstraints(2.5, 2.5));
        ...
        SwerveAutoBuilder autoBuilder = new SwerveAutoBuilder(
                ...
                new PIDConstants(3.2, 0.0, 0.0), // PID constants to correct for translation error (used to create the X
