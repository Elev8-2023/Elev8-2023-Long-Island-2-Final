...
public class Arm extends SubsystemBase {
  ...
  public Arm() {
    ...
    this.Elbow.configPeakOutputForward(0.5);//down
    this.Elbow.configPeakOutputReverse(-0.7);//up
    ...
    this.Elbow.configMotionCruiseVelocity(25000, 30);
		this.Elbow.configMotionAcceleration(25000, 30);
    ...
    this.Arm.configPeakOutputForward(0.7);//front
    this.Arm.configPeakOutputReverse(-0.5);//back
    ...
    this.Arm.configMotionCruiseVelocity(25000, 30);
		this.Arm.configMotionAcceleration(25000, 30);
    ...
    ArmCancoderzero = 216;
    ElbowCancoderzero = 189.5;//197; //7.5 degrees per gear spoke
  ...
  public void periodic() {
    ...
    // SmartDashboard.putNumber("Elbow Sensor Psoition", this.Elbow.getSelectedSensorPosition());
